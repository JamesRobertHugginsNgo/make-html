...
**Making Document Fragment**

``` JavaScript
const definition = { children: [{ name: 'strong', children: ['Hello'] }] };
const fragment = makeHtml(definition);
...
appendChildren(fragment, svg, 'http://www.w3.org/2000/svg');
```
